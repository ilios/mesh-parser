...
EOL;
    ...
    public function testParse2025(): void
    {
        $file = __DIR__ . '/desc2025.xml';
        ...
        $this->assertNull($descriptor->getLastUpdated());
        $this->assertNull($descriptor->getDateIntroduced());
    ...
    public function testParse2026(): void
    {
        $file = __DIR__ . '/desc2026.xml';
        $descriptorsSet = $this->parser->parse($file);
        ...
        $this->assertEquals('D000000', $descriptor->getUi());
        $this->assertEquals('1', $descriptor->getClass());
        $this->assertEquals('2016/12/08', $descriptor->getLastUpdated()->format('Y/m/d'));
        $this->assertEquals('2016/12/09', $descriptor->getDateIntroduced()->format('Y/m/d'));
        $this->assertNull($descriptor->getDateEstablished());
        $this->assertNull($descriptor->getDateRevised());
        $this->assertNull($descriptor->getDateEstablished());
